                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                New User</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $pelanggan_baru[0]["jumlah_pelanggan_baru"]; ?></div>
                                        </div>
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Users</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_pelanggan[0]["jumlah_pelanggan"]; ?></div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Pegawai</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_driver[0]["jumlah_driver"]; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-user fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Peminjaman Mobil</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $total_peminjaman[0]["total_peminjaman"]; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-dollar-user fa-2x text-gray-300"></i>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Requests Peminjaman</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $request_peminjaman[0]["request_peminjaman"]; ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-cars fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Menunggu payment</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $menunggu_pembayaran[0]["menunggu_pembayaran"]; ?></div>
                                        </div>
                                        <div class="col-auto">
